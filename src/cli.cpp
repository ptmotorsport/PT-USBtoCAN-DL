...
void CLIHandler::showRTCDiag() {
  ...
  // Note: The RTC is configured with external 32.768kHz crystal via RTC_CLOCK_SOURCE_SUBCLK macro
  
  Serial.print("RTC Status:       ");
  Serial.println(rtcRunning ? "RUNNING" : "STOPPED");
  
  Serial.print("SOSC Enabled:     ");
  Serial.println("YES");
  
  Serial.print("RTC Source:       SUBCLK (32.768 kHz external crystal)");
  Serial.println();
